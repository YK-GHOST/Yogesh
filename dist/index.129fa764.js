...
})({"919iL":[function(require,module,exports) {
...
class App {
    ...
    createCursor() {
        return new (0, _cursorDefault.default)();
    }
    create() {
        this.Navigation = new (0, _navigationDefault.default)();
        this.works = new (0, _worksDefault.default)();
    }
}
new App();

},{"./Cursor/Cursor":"apYWF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./components/Navigation":"fg7Cm","./components/Works":"5AMzV"}],"apYWF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Cursor {
    ...
    create() {
        ...
        (0, _lodash.each)(this.hoveredElement, (element)=>{
...
},{}],"fg7Cm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _gsap = require("gsap");
var _components = require("../classes/Components");
...
class Navigation extends (0, _componentsDefault.default) {
    constructor(){
        super({
            element: ".navigation",
            elements: {
    ...
    createAnimations() {
        (0, _gsap.gsap).set(this.elements.navBar, {
            width: 0
        });
        this.st = (0, _scrollTrigger.ScrollTrigger).create({
            trigger: "",
            start: "top top",
            pin: true,
            scrub: 1,
            onUpdate: ()=>{
                this.elements.navBar.style.width = `${window.scrollY / document.documentElement.clientHeight * 100}%`;
            }
        });
    }
    showNavigation() {
        ...
        this.timeline.from(".navigation__menu > div", {
            y: 100,
            duration: 0.8,
            opacity: 0,
            ease: "power1.inOut",
        ...
        this.timeline.from(".navigation__socials", {
            y: 100,
            duration: 0.8,
            opacity: 0,
            ease: "power1.inOut"
    ...
    addListeners() {
        (0, _lodash.each)(this.elements.navLinks, (link)=>{
...
},{"../classes/Components":"dhHHy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","gsap":"fPSuC","lodash":"3qBDj","gsap/ScrollTrigger":"7wnFk"}],"dhHHy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _lodash = require("lodash");
class Component {
    ...
    create() {
        ...
        this.elements = {};
        (0, _lodash.each)(this.selectorChildren, (entry, key)=>{
            if (entry instanceof window.HTMLElement || entry instanceof window.NodeList) this.elements[key] = entry;
            else if (Array.isArray(entry)) this.elements[key] = entry;
            else {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","lodash":"3qBDj"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5AMzV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _components = require("../classes/Components");
var _componentsDefault = parcelHelpers.interopDefault(_components);
...
var _scrollTrigger = require("gsap/ScrollTrigger");
(0, _gsap.gsap).registerPlugin((0, _scrollTrigger.ScrollTrigger));
class Works extends (0, _componentsDefault.default) {
    constructor(){
        super({
            element: ".works",
            elements: {
...
},{"../classes/Components":"dhHHy","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["919iL","gp8bJ"], "gp8bJ", "parcelRequired7a2")
